...
class Ays_Quiz_Maker_Extra_Shortcodes_Public
{
    ...
    */
    ...
    public function ays_quiz_passed_users_count_html( $id ){
        ...
        $results = $this->get_quiz_results_count_by_id( $id );
    ...
    */
    ...
    public function ays_generate_user_quiz_duration_html(){
        ...
        $quiz_duration = "";
        if ( class_exists( "Quiz_Maker_Public" ) ) {
            if ( !is_null( $results ) && !empty( $results ) ) {
                $quiz_duration = Quiz_Maker_Public::secondsToWords($results);
            }
        }
    ...
    */
    ...
    public function get_curent_quiz_creation_date( $id ){
        ...
        $sql = "SELECT `options` FROM `{$quizzes_table}` WHERE `id` = {$id}";
    ...
    */
    ...
    public function ays_generate_category_title_html( $id ) {
        ...
        $results = Quiz_Maker_Public::get_quiz_category_by_id($quiz_category_id);
    ...
    */
    ...
    public function ays_generate_question_categories_description_html( $id ) {
        ...
        $question_category_description = (isset($results['description']) && $results['description'] != '') ? Quiz_Maker_Public::ays_autoembed($results['description']) : "";
    ...
    */
    ...
    public static function ays_quiz_get_quizzes_count(){
        ...
        $sql = "SELECT count(*) as res_count FROM {$wpdb->prefix}aysquiz_quizes";
    ...
    */
    ...
    /*
    ==========================================
        Show quizzes total results count | Start
    ==========================================
    */

    public function ays_generate_quiz_all_results_count_method(){
    ...
    public function ays_generate_quiz_all_results_count_html(){

        $results = $this->ays_quiz_get_all_quizzes_results_count();
        ...
        $all_results_count = (isset( $results['res_count'] ) && $results['res_count'] ) != "" ? $results['res_count'] : '';

        $content_html[] = "<span class='". $this->html_name_prefix ."all-results-count' id='". $this->html_name_prefix ."all-results-count-". $this->unique_id_in_class ."' data-id='". $this->unique_id ."'>";
            $content_html[] = $all_results_count;
        $content_html[] = "</span>";
    ...
    public static function ays_quiz_get_all_quizzes_results_count(){
        global $wpdb;
    ...
    /*
    ==========================================
        Show quizzes total results count | End
    ==========================================
    */

    /*
    ==========================================
        Question categories count | Start
    ==========================================
    */

    public function ays_generate_quiz_question_categories_count_method(){
    ...
    public function ays_quiz_question_categories_count_html(){
        ...
        $content_html[] = "<span class='". $this->html_name_prefix ."question-categories-count' id='". $this->html_name_prefix ."question-categories-". $this->unique_id_in_class ."' data-id='". $this->unique_id ."'>";
            $content_html[] = $read_results_count;
        $content_html[] = "</span>";
    ...
    public static function ays_quiz_get_question_categories_count(){
        global $wpdb;

        $sql = "SELECT count(*) as res_count FROM {$wpdb->prefix}aysquiz_categories";
