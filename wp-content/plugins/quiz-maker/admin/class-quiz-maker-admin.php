...
class Quiz_Maker_Admin
{
    ...
    public function ays_show_results(){
        ...
        if (isset($_REQUEST['action']) && sanitize_text_field( $_REQUEST['action'] ) == 'ays_show_results') {
            ...
            $pro_content[] = '<div class="only_pro only_pro_save_as_default" style="margin: 0 10px;" title="'.__("This property aviable only in pro version",$this->plugin_name) .'">';
                ...
                $pro_content[] = '<div>';
                    ...
                    $pro_content[] = '<a href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" class="ays-pro-a" style="margin: 0 10px;">';
                        $pro_content[] = '<span type="button" class="disabled-button" title="This property aviable only in pro version">'.__("PDF", $this->plugin_name).'</span>';
                    $pro_content[] = '</a>';

                    $pro_content[] = '<a href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" class="ays-pro-a">';
                        $pro_content[] = '<span type="button" class="disabled-button" title="This property aviable only in pro version">'.__("XLSX", $this->plugin_name).'</span>';
                    $pro_content[] = '</a>';
                $pro_content[] = '</div>';
            $pro_content[] = '</div>';
            ...
            $admin_note_content[] = '<div class="only_pro only_pro_save_as_default" style="margin: 0 10px;" title="'.__("This property aviable only in pro version",$this->plugin_name) .'">';
                $admin_note_content[] = '<div class="pro_features pro_features_popup">';
                    $admin_note_content[] = '<div class="pro-features-popup-conteiner">';
                        ...
                        $admin_note_content[] = '<div class="pro-features-popup-button" data-link="https://ays-pro.com/wordpress/quiz-maker">';
                ...
                $admin_note_content[] = '<div>';
                    ...
                    $admin_note_content[] = '<div class="ays-quiz-click-for-admin-note">';
                        $admin_note_content[] = '<a href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" class="ays-pro-a">';
                            $admin_note_content[] = '<button class="button button-primary disabled-button" style="color:#ffffff !important; font-weight:normal;" title="This property aviable only in pro version">';
    ...
    */
    ...
    public function ays_quiz_sale_baner(){
        if(isset($_POST['ays_quiz_sale_btn'])){
            ...
            $content[] = '<div id="ays-quiz-dicount-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-month" class="ays_quiz_dicount_month">';
                    ...
                    $content[] = '<div class="ays-quiz-dicount-wrap-box">';
                        ...
                        $content[] = '<strong>';
                                $content[] = __( "Hurry up! <a href='https://ays-pro.com/mega-bundle' target='_blank'>Check it out!</a>", AYS_QUIZ_NAME );
                        $content[] = '</strong>';
            ...
            $content[] = '<div id="ays-quiz-dicount-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-month" class="ays_quiz_dicount_month">';
                    ...
                    $content[] = '<div class="ays-quiz-dicount-wrap-box">';
                        ...
                        $content[] = '<strong>';
                                $content[] = __( "Hurry up! <a href='https://ays-pro.com/wordpress/quiz-maker' target='_blank'>Check it out!</a>", AYS_QUIZ_NAME );
                        $content[] = '</strong>';
                ...
                $content[] = '<div id="ays-quiz-dicount-month-helloween" class="ays_quiz_dicount_month_helloween">';
                    $content[] = '<div class="ays-quiz-dicount-wrap-box-helloween-limited">';
                        ...
                        $content[] = '<p>';
                            ...
                            <span class='ays-quiz-dicount-wrap-color-helloween' style='color:#b2ff00;'>50%</span> 
                            <span>
                                SALE on
                            </span> 
                            <br>
                            <span style='' class='ays-quiz-helloween-bundle'>
                                <a href='https://ays-pro.com/mega-bundle' target='_blank' class='ays-quiz-dicount-wrap-color-helloween ays-quiz-dicount-wrap-text-decoration-helloween' style='display:block; color:#b2ff00;margin-right:6px;'>
                                    Mega Bundle
                                </a>
                                (Quiz + Survey + Poll)!
                            </span>", AYS_QUIZ_NAME );
                        ...
                        $content[] = '<p>';
                                $content[] = __( "Hurry up! 
                                                <a href='https://ays-pro.com/mega-bundle' target='_blank' style='color:#ffc700;'>
                                                    Check it out!
                                                </a>", AYS_QUIZ_NAME );
                        $content[] = '</p>';
                    ...
                    $content[] = '<div class="ays-quiz-helloween-bundle-buy-now-timer">';
                        ...
                        $content[] = '<div class="ays-quiz-dicount-wrap-box ays-buy-now-button-box-helloween">';
                            $content[] = '<a href="https://ays-pro.com/mega-bundle" class="button button-primary ays-buy-now-button-helloween" id="ays-button-top-buy-now-helloween" target="_blank" style="" >' . __( 'Buy Now !', AYS_QUIZ_NAME ) . '</a>';
                        $content[] = '</div>';
                    $content[] = '</div>';
                ...
                $content[] = '<div style="position: absolute;right: 0;bottom: 1px;"  class="ays-quiz-dismiss-buttons-container-for-form-helloween">';
                    $content[] = '<form action="" method="POST">';
                        $content[] = '<div id="ays-quiz-dismiss-buttons-content-helloween">';
                            $content[] = '<button class="btn btn-link ays-button-helloween" name="ays_quiz_sale_btn" style="">Dismiss ad</button>';
                        $content[] = '</div>';
                    $content[] = '</form>';
                $content[] = '</div>';
                    ...
                    $content[] = '<div class="ays-quiz-dicount-wrap-box ays-quiz-dicount-wrap-text-box">';
                        $content[] = '<div>';
                            ...
                            $content[] = '<span class="ays-quiz-new-mega-bundle-title">';
                                $content[] = __( "<span><a href='https://ays-pro.com/mega-bundle' target='_blank' style='color:#ffffff; text-decoration: underline;'>Mega Bundle</a></span> (Quiz + Survey + Poll)", AYS_QUIZ_NAME );
                            $content[] = '</span>';
                            $content[] = '</br>';
