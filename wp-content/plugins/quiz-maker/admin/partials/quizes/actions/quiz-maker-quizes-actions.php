    ...
    <div class="container-fluid">
        <form class="ays-quiz-category-form" id="ays-quiz-category-form" method="post">
                    ...
                    <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                        <div class="pro_features pro_features_popup">
                            <div class="pro-features-popup-conteiner">
                                ...
                                <div class="pro-features-popup-button" data-link="https://ays-pro.com/wordpress/quiz-maker">
                ...
                <div class="form-group row" style="margin:0px;">
                    <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="ays-text-input" id="ays_main_quiz_url" tabindex="-1" value=""/>
                            </div>
                        </div>
                        <a href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" class="ays-quiz-new-upgrade-button-link">
                            <div class="ays-quiz-new-upgrade-button-box">
            ...
            <?php
                ...
                $pro_content[] = '<div class="only_pro only_pro_save_as_default" title="'.__("This property aviable only in pro version",$this->plugin_name) .'">';
                    ...
                    $pro_content[] = '</div>';
                    $pro_content[] = '<div>';
                        $pro_content[] = '<a href="https://ays-pro.com/wordpress/quiz-maker" class="" target="_blank" title="'.__("This property aviable only in pro version",$this->plugin_name) .'">';
