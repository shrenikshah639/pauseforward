                        ...
                        <thead>
                            ...
                            <?php endif; ?>
                                <th class="only_pro ays-weight-row ays-quiz-question-answer-weight-point-row" style="width:120px;padding:0;"><?php echo __('Weight/Point', $this->plugin_name); ?><br>
                                    <a style="text-transform: capitalize;" tabindex="-1" class="only_pro_lik" href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" title="PRO feature"><?php echo __("PRO feature!!!", $this->plugin_name); ?></a>
                                </th>
