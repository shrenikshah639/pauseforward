    ...
    <div class="ays-quiz-features-wrap">
        <div class="comparison">
            <table>
                    ...
                    <tr>
                        ...
                        <th class="price-info">
                            ...
                            <div class="ays-quiz-pracing-table-td-flex">
                                <a href="https://ays-pro.com/wordpress/quiz-maker" class="price-buy"><?php echo __('Buy now',$this->plugin_name)?><span class="hide-mobile"></span></a>
                ...
                <tr>
                    <td></td>
                    <td colspan="4"><?php echo __('Sendinblue integration',$this->plugin_name)?></td>
                </tr>
                <tr>
                    <td><?php echo __('Sendinblue integration',$this->plugin_name)?></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><span>–</span></td>
                    <td><i class="ays_fa ays_fa_check"></i></td>
