        ...
        $(document).find('#ays-type').on('change', function(e){
            ...
            if($(this).val() == 'date'){
                ...
                if($(document).find('table#ays-answers-table tbody').hasClass('text_answer') || true_or_false_flag){
                    ...
                    var keyworHtml = '<th class="only_pro th-150 removable" style="width:120px;padding:0;">Keyword<br><a style="text-transform: capitalize;" tabindex="-1" class="only_pro_lik" href="https://ays-pro.com/wordpress/quiz-maker" target="_blank" title="PRO feature">PRO feature!!!</a></th>';
                    ...
                    for(row_id = 1; row_id <= default_answer_count; row_id++){
                        ...
                        var answerRow = '<tr class="ays-answer-row ui-state-default">'+
                                    ...
                                    '<td class="ays-quiz-question-answer-correct-row">'+
                                        ...
                                        '</span>'+
                                    '</td>'+
                                    '<td title="This property aviable only in pro version" class="only_pro ays-quiz-question-answer-weight-point-row">'+
                                        '<div class="pro_features"></div>'+
                                        '<input class="w-100" type="number" value="2" tabindex="-1"/>'+
                                    '</td>'+
                                    '<td title="This property aviable only in pro version" class="only_pro ays-quiz-question-answer-keyword-row">'+
                                        '<div class="pro_features"></div>'+
                                    ...
                                    '</td>'+
                                    '<td title="This property aviable only in pro version" class="ays-quiz-question-answer-image-row">'+
